...
public class StudentsProvider extends ContentProvider {
    ...
    static final String  PROVIDER_NAME="com.shablcu.shalu.provider.college";
    ...
    static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY AUTOINCREMENT," +
            " name VARCHAR(255) NOT NULL, grade VARCHAR(255) NOT NULL);";
    ...
    public String getType(Uri uri) {
            ...
            switch (uriMatcher.match(uri)){
                 ...
                 */
                case STUDENTS:
                    return "vnd.android.cursor.dir/vnd..shablcu.shalu..student";

                /**
                 * Get a particular student
                 */
                case STUDENT_ID:
                    return "vnd.android.cursor.item/vnd..shablcu.shalu..student";
